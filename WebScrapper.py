...
if __name__ == "__main__":
    ...
    if scraped_data:
        ...
        final_dataFrame = pd.read_csv('Tech-Ottawa,ON-yellowpages-scraped-data.csv')
        final_excel_path = '%s-%s-yellowpages-scraped-data.xlsx' % (keyword, place)
        final_dataFrame.to_excel(final_excel_path, index=False)
